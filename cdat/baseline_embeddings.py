...
from embeddings import cdat_fasttext, cdat_glove, cdat_bert_layers

# ============================================================================
# Parse command-line argument
# ============================================================================
if len(sys.argv) < 2:
    print("Usage: python baseline_embeddings.py <input_json_file>")
    print("Example: python baseline_embeddings.py random_results550.json")
    sys.exit(1)
...
output_file = f'./csv_data/results_with_embeddings_{input_basename}_baselines.csv'
...
# Initialize models
bert_model = bert_layers(model_name='bert-base-uncased')
fasttext_model = fasttext(model_name='fasttext/cc.en.300.bin')
glove_model = glove()
